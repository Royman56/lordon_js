                  ...
                  >
                    <div className="footer-contant">
                      <ul className="contact-details">
                        ...
                        <li>
                          Email: <a href={null}>Support@Fiot.com</a>
                        </li>
                        <li>Fax: 123456</li>
                      </ul>
                    </div>
                    ...
                    <div className="footer-link">
                      ...
                      >
                        <div className="footer-contant">
                          <ul>
                            <li>
                              <a href={null}>hombres</a>
                            </li>
                            <li>
                              <a href={null}>mujeres</a>
                            </li>
                            <li>
                              <a href={null}>ropa</a>
                            </li>
                            <li>
                              <a href={null}>accesorios</a>
                            </li>
                            <li>
                              <a href={null}>destacado</a>
                            </li>
                          </ul>
                        </div>
                      </Collapse>
